...
?>
	...
	<div id="ais-wrapper">
		...
		<aside id="ais-facets">
            ...
            <h2>Book based filters</h2>
            <div>
                <h3 class="widgettitle"><?php esc_html_e( 'Book Status', 'wp-search-with-algolia' ); ?></h3>
                <section class="ais-facets" id="facet-book_status"></section>
            </div>
            <div>
